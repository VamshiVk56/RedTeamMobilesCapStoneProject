...
<body>
 <div class="topnav sticky">  
            <center><h2><img src="../../image/apple_raw.png" width="28">Red Mobile Store - Manage Couponss<i class="fa fa-edit"></i></h2></center>
...
<div style="color: white; text-align: center; font-size: 30px;">Search results of coupons </div>
<table>
        <thead>
          <tr>
            <th scope="col">ID</th>
...
try
{
	...
	ResultSet rs=st.executeQuery("select * from coupon where name like '%"+search+"%'" );
	while(rs.next())
	{
		z=1;
%>
